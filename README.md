...
### 💫 About Me
I’m a Software Engineer passionate about building scalable, high-performance applications. My expertise spans the **Java ecosystem** and **modern JavaScript frameworks**, allowing me to architect systems that are efficient, maintainable, and future-ready.

- 🎓 **Currently:** Advancing my knowledge via Master’s in CS at **Woolf University** & **Scaler Academy**.
- 🚀 **Performance:** Improved backend latency by **80%** through structural refactoring.
- 💡 **Innovation:** Reduced operational costs by **35%** by building an in-house routing engine.
- 🤝 **Leadership:** Committed to mentoring and upholding clean code (SOLID, DRY) practices.
- 📈 **Interests:** Beyond code, I analyze financial markets and play guitar.
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=coderAsh1&label=Profile%20views&color=0e75b6&style=flat" alt="Views" />
</div>
